 ...
 */
  ...
  //topic_pub = "/x_" + WiFi.macAddress();
  //topic_sub = "/r_" + WiFi.macAddress();
...
/*
                // Publish
                if (mqttClient.publish(topic_pub, "Hi~~~")) {
...
/*
    if ( mqttClient.publish((char *)topic_pub.c_str(), (char *)pl.c_str()) )
...
String readFromOneWire()
{
    ...
    for ( i = 0; i < 8; i++) {
		...
		//payload += Serial.print(addr[i], HEX);
    }
    ...
    switch (addr[0]) {
		  ...
		  payload += Serial.print("DS18S20x10");
          type_s = 1;
          break;
    case 0x28:
          Serial.println("  Chip = DS18B20");
		  payload += Serial.print("DS18S20x28");
          type_s = 0;
          break;
    case 0x22:
          Serial.println("  Chip = DS1822");
		  payload += Serial.print("DS1822x22");
          type_s = 0;
          break;
    default:
